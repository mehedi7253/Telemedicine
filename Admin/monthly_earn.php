                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if (isset($_POST['search']) == true) {
                                    if ($rows > 0) {
                                        $total = "SELECT SUM(fee) AS TotalVisit FROM appointment WHERE MONTH(create_at) = '$searchKey'";
                                        ...
                                        <div class="table-responsive">
                                            <table id="myTable" class="display table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($appoint_data = mysqli_fetch_assoc($res_s)) { ?>
                                                        <tr>
                                                            ...
                                                            <?php
                                                                $totalappoint = "SELECT SUM(fee) AS TotalAppoint FROM appointment WHERE MONTH(create_at) = '$searchKey' AND doctor_id = '$appoint_data[doctor_id]'";
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td></td>
                                                        <td><span class="float-right">Totoal Earn:</span> </td>
